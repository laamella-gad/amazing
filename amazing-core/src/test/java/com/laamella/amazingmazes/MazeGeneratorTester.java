...
import com.laamella.amazingmazes.generators.daedalus.AldousBroderMazeGenerator;
import com.laamella.amazingmazes.generators.daedalus.BinaryTreeMazeGenerator;
import com.laamella.amazingmazes.generators.daedalus.EllerMazeGenerator;
import com.laamella.amazingmazes.generators.daedalus.GrowingTreeMazeGenerator;
import com.laamella.amazingmazes.generators.daedalus.KruskalMazeGenerator;
import com.laamella.amazingmazes.generators.daedalus.PrimMazeGenerator;
import com.laamella.amazingmazes.generators.daedalus.RecursiveBacktrackerMazeGenerator;
...
public class MazeGeneratorTester {
	...
	public void testWallSetup() {
		assertTrue(grid.getSquare(new Position(1, 1)).getWall(RIGHT) == grid.getSquare(new Position(2, 1))
				.getWall(LEFT));
	}
